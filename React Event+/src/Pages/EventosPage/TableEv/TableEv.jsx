            ...
            <tbody>
                {
                    dados.map((evento) => {
                        return (
                            <tr className='table-data__head-row'>
                                <td className="table-data__data table-data__data--big">{evento.nome}</td>
                                <td className="table-data__data table-data__data--little">{evento.descricao}</td>
                                <td className="table-data__data table-data__data--little">{evento.tipoEvento}</td>
                                <td className="table-data__data table-data__data--little">{evento.data}</td> 
